...
import { base64, plain, xor } from './codecs.js';
import { db, getCookies, serialize, setCookies, validateCookie } from './cookie.js';
import CSS from './css.js';
import HTML from './html.js';
import JS from './js.js';
import { attributes, createHtmlInject, createJsInject, injectHead, isForbidden, isHtml, isSrcset, isStyle, isUrl, text } from './rewrite.html.js';
...
import { dynamicImport, identifier, importDeclaration, importMeta, property, unwrap, wrapEval } from './rewrite.script.js';
...
class Ultraviolet {
  ...
  sourceUrl(str, meta = this.meta) {
    if (!str || this.urlRegex.test(str)) return str;
    try {
      return new URL(this.decodeUrl(str.slice(this.prefix.length + meta.origin.length)), meta.base).href;
    } catch {
